...
<section class="container">
    ...
    <section class="row">
        ...
        <div class="homepage_column col-md-8 well">
            <h3>About us</h3>
            <p class="homepage_section-heading">Who We Are:</p>
            ...
            <p class="homepage_section-heading">Are you ready to learn?</p>
            ...
            <p class="homepage_section-heading">What you need?</p>
            ...
            <p class="homepage_section-heading">WE want YOU to learn.</p>
